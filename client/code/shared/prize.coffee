...
exports.conjunctions=["の","与","和","，","👀","👿","😈","With","を","が","は","で","と","な","に","し","い","す","だ","ぜ","も","ん","た","風","なる","たる","での","への","から","かつ","でも","する","した","され","オブ","にして","として","無き","☆","★","♡","♥","・","×","✝","ッ","！","デース","？","的","是","如","把","被","之","要","将","从","因为","所以","但是","竟然","然而","没有","成为","THE","OF","AND","NOT","ANY","NEVER"]
