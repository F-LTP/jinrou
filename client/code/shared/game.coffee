...
# ------ 役職一覧
# 基本役職
exports.jobs=["Human","Werewolf","Diviner","Psychic","MindPsychic","Madman","Guard","OldGuard","Couple","Fox",
# ミラーズホロウの人狼
...
exports.new_rules=[
    ...
    # 护卫职业
    {
        ...
        label:
            ...
            visible:(rule)->
                return true if isAllJobsMode rule
                for job in ["Guard","OldGuard","Trapper","WanderingGuard","Cosplayer","SuperGuard","Paladin"]
                    if rule.jobNumbers[job]>0
                        return true
                return false
        items:[
